...
| 音频编码格式 | AAC, MP3, NELLYMOSER, SPEEX |AAC, MP3, AMR, APE, DTS, FLAC, PCM, OGG, WMA, COOK, NELLYMOSER, SPEEX|
...
- [x] 支持[播放端动态贴纸、滤镜功能](https://github.com/ksvc/KSYDiversityLive_iOS/tree/master/FaceUnitySDK/playerdemo)
